...
func constructPostedData(sd, ed, fn, ln, em, ph, rid string) url.Values {
	postedData := url.Values{}
	postedData.Add("start_date", sd)
	postedData.Add("end_date", ed)
	postedData.Add("first_name", fn)
	postedData.Add("last_name", ln)
	postedData.Add("email", em)
	postedData.Add("phone", ph)
	postedData.Add("room_id", rid)
	return postedData
}
...
func TestRepository_PostReservation(t *testing.T) {
	tests := []struct {
		...
		{
			name: "first",
			postedData: constructPostedData(
				"2050-01-01",
				"2050-01-02",
				"John",
				"Smith",
		...
		{
			name: "failed to insert reservation into database",
			postedData: constructPostedData(
				"2050-01-01",
				"2050-01-02",
				"John",
		...
		{
			name: "failed to insert restriction into database",
			postedData: constructPostedData(
				"2050-01-01",
				"2050-01-02",
				"John",
